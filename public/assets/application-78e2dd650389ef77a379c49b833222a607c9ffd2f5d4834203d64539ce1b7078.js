...
(function() {
  var getScrollWidth, setScrollWidth;

  setScrollWidth = function() {
    var timelineWidth;
    timelineWidth = document.getElementById('timeline_container').scrollWidth;
    document.getElementById('myProgress').style.width = timelineWidth + 'px';
  };
  ...
  $(function() {
    $('.timeline_section').mousewheel(function(event, delta) {
  ...
  $(document).ready(function() {
    $('.timeline_section').scroll(function() {
      ...
      sposition = 100 * $('.timeline_section').scrollLeft() / document.getElementById('timeline_container').scrollWidth;
      document.getElementById('timeline_lscroll').innerHTML = sposition;
      document.getElementById('myBar').style.width = sposition + '%';
    });
  });
