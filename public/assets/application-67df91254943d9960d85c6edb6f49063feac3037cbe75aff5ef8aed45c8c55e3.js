...
(function() {
  var QuickState, curState, disableButtons, intervalHolder, nextStateSlide, prevStateSlide, setQuickSelectValues, stopAutoSlide, turnOnButtons;
  ...
  intervalHolder = void 0;

  $(document).ready(function() {
    $('#playUSstate').click(function() {
      if (curState < 50) {
        disableButtons();
  ...
  $(document).ready(function() {
    $('#stopUSstate').click(function() {
      stopAutoSlide();
    });
  });

  $(document).ready(function() {
    $('#reverseUSstate').click(function() {
      if (curState >= 1) {
        disableButtons();
        $('#stopUSstate').prop('disabled', false);
  ...
  QuickState = function(callback, repetitions) {
    var intervalID, x;
    x = 0;
  ...
  $(document).ready(function() {
    $('#ddl_states_name').change(function() {
      var nextDistance, prevDistance;
      disableButtons();
  ...
  $(document).ready(function() {
    $('#ddl_states_num').change(function() {
      var nextDistance, prevDistance;
      disableButtons();
  ...
  disableButtons = function() {
    ...
    $('#stopUSstate').prop('disabled', true);
    $('#tl_left_div').addClass("deactivate");
    return $('#tl_right_div').addClass("deactivate");
  };
  ...
  turnOnButtons = function() {
    ...
    if (curState === 0) {
      ...
      return $('#tl_left_div').addClass("deactivate");
    } else if (curState === 50) {
      $('#playUSstate').prop('disabled', true);
      ...
      $('#reverseUSstate').prop('disabled', false);
      $('.prevUSstate').prop('disabled', false);
      return $('.nextUSstate').prop('disabled', false);
    }
  };
...
(function() {
  (function(factory) {
    ...
    var handler, i, lowestDelta, lowestDeltaXY, toBind, toFix;
    toFix = ['wheel', 'mousewheel', 'DOMMouseScroll', 'MozMousePixelScroll'];
    toBind = 'onwheel' in document || document.documentMode >= 9 ? ['wheel'] : ['mousewheel', 'DomMouseScroll', 'MozMousePixelScroll'];
    lowestDelta = void 0;
    lowestDeltaXY = void 0;
    handler = function(event) {
      var absDelta, absDeltaXY, args, delta, deltaX, deltaY, fn, orgEvent, rawDelta;
