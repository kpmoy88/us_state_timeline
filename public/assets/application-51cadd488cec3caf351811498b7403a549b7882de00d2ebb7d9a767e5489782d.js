...
(function() {
  var QuickState, curState, intervalHolder, nextStateSlide, prevStateSlide;
  ...
  prevStateSlide = function() {
    ...
    last.toggle();
    curState--;
    return $('.map_image').attr('src', $('#state_el_' + curState).data('map-image'));
  };
  ...
  $(document).ready(function() {
    $('.timeline_section').scroll(function() {
      if (curState === 50 && $('#scrollquestion').get(0).scrollWidth - $('#scrollquestion').scrollLeft() === $('#scrollquestion').outerWidth()) {
        alert('right end');
      }
    });
  });
